...
1. **Add the SDK package** — in Xcode, **File → Add Package Dependencies…** with `https://github.com/patch-release/patch-swift` (product `PatchSDK`, from `1.7.0`). See [SDK reference](/sdk/) for the `Package.swift` form.

...
description: "Run production, staging and beta as separate OTA release streams from one build: set the channel in PatchSDK, then release with patchcli release --channel."
sidebar:
  order: 7
sources:
  - cli/Sources/PatchCLI/Channels.swift

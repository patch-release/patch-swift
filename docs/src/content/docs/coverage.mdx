...
twenty named apps are public repositories measured at pinned commits, so you can
verify those yourself; the eight `first-party-app-*` rows are our own apps,
included because dogfooding is the point but not named:
